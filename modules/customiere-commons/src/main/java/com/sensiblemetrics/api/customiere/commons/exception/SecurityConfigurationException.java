...
public class SecurityConfigurationException extends RuntimeException {
    ...
    public static SecurityConfigurationException throwInvalidSecurityConfiguration(final Object target) {
        throw throwInvalidSecurityConfigurationWith(ErrorTemplateType.INVALID_ENDPOINT_SECURITY_CONFIGURATION.getErrorMessage(), target);
    }
    ...
    public static SecurityConfigurationException throwInvalidSecurityConfiguration(final Object target, final Throwable throwable) {
        throw new SecurityConfigurationException(MessageSourceHelper.getMessage(ErrorTemplateType.INVALID_ENDPOINT_SECURITY_CONFIGURATION.getErrorMessage(), target), throwable);
    }
