package com.sensiblemetrics.api.customiere.executor.configuration;

import com.sensiblemetrics.api.customiere.executor.handler.DelegatedAsyncUncaughtExceptionHandler;
import com.sensiblemetrics.api.customiere.executor.handler.DelegatedRejectedExecutionHandler;
import com.sensiblemetrics.api.customiere.executor.handler.DelegatedTimeoutCallableProcessingInterceptor;
...
public abstract class WebServiceExecutorConfiguration {
    /**
    ...
    @RequiredArgsConstructor
    @Role(BeanDefinition.ROLE_INFRASTRUCTURE)
    @Description("SensibleMetrics WebService Task Executor configuration")
    public static class TaskExecutorConfiguration implements AsyncConfigurer {
        /**
    ...
    @Description("Asynchronous uncaught exception handler bean")
