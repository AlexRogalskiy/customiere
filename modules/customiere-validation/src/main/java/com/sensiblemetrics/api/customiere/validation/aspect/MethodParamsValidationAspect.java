package com.sensiblemetrics.api.customiere.validation.aspect;

import com.sensiblemetrics.api.customiere.validation.annotation.ValidateInput;
import com.sensiblemetrics.api.customiere.validation.exception.DataValidationException;
...
public class MethodParamsValidationAspect {
     ...
     */
    @Pointcut("@annotation(com.sensiblemetrics.api.customiere.validation.annotation.ValidateInput)" +
        "|| @within(com.sensiblemetrics.api.customiere.validation.annotation.ValidateInput)")
