package com.sensiblemetrics.api.customiere.metrics.aspect;
...
public class MonitoringTimeAspect {
    ...
    @Pointcut("@annotation(com.sensiblemetrics.api.customiere.metrics.annotation.MonitoredComponent) " +
            "|| @within(com.sensiblemetrics.api.customiere.metrics.annotation.MonitoredComponent)")
    public void monitoredComponentPointcut() {
    }

    @Pointcut("@annotation(com.sensiblemetrics.api.customiere.metrics.annotation.MonitoredService) " +
            "|| @within(com.sensiblemetrics.api.customiere.metrics.annotation.MonitoredService)")
    public void monitoredServicePointcut() {
    }

    @Pointcut("@annotation(com.sensiblemetrics.api.customiere.metrics.annotation.MonitoredRepository) " +
            "|| @within(com.sensiblemetrics.api.customiere.metrics.annotation.MonitoredRepository)")
    public void monitoredRepositoryPointcut() {
    }

    @Pointcut("(@annotation(com.sensiblemetrics.api.customiere.metrics.annotation.MonitoredComponent) " +
            "|| @within(com.sensiblemetrics.api.customiere.metrics.annotation.MonitoredComponent))" +
            "|| (@annotation(com.sensiblemetrics.api.customiere.metrics.annotation.MonitoredRestController) " +
            "|| @within(com.sensiblemetrics.api.customiere.metrics.annotation.MonitoredRestController))")
