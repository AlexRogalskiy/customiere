package com.sensiblemetrics.api.customiere.metrics.configuration;

import com.sensiblemetrics.api.customiere.commons.helper.OptionalConsumer;
import com.sensiblemetrics.api.customiere.metrics.aspect.MonitoringTimeAspect;
import com.sensiblemetrics.api.customiere.metrics.aspect.TrackingTimeAspect;
import com.sensiblemetrics.api.customiere.metrics.property.WebServiceMetricsProperty;
...
@Import(MetricsConfigurerAdapter.class)
@ConditionalOnProperty(prefix = WebServiceMetricsProperty.PROPERTY_PREFIX, value = "enabled", havingValue = "true", matchIfMissing = true)
@EnableConfigurationProperties(WebServiceMetricsProperty.class)
@Role(BeanDefinition.ROLE_INFRASTRUCTURE)
@Description("SensibleMetrics Web Service Metrics configuration")
public abstract class WebServiceMetricsConfiguration {
    /**
    ...
    public MeterRegistryCustomizer<MeterRegistry> metricsNamingConventionCustomizer(final WebServiceMetricsProperty metricsProperty) {
    ...
    public MeterRegistryCustomizer<MeterRegistry> metricsCommonTagsCustomizer(final WebServiceMetricsProperty metricsProperty) {
    ...
    public WebMvcTagsContributor webMvcTagsContributor(final WebServiceMetricsProperty metricsProperty) {
    ...
    @ConditionalOnProperty(prefix = WebServiceMetricsProperty.Handlers.MONITORING_TIME_PROPERTY_PREFIX, value = "enabled", havingValue = "true")
    ...
    @ConditionalOnProperty(prefix = WebServiceMetricsProperty.Handlers.TRACKING_TIME_PROPERTY_PREFIX, value = "enabled", havingValue = "true")
    ...
    public MeterFilter includeMeterFilter(final MetricsConfigurerAdapter configurerAdapter,
                                          final WebServiceMetricsProperty metricsProperty) {
    ...
    public MeterFilter excludeMeterFilter(final MetricsConfigurerAdapter configurerAdapter,
                                          final WebServiceMetricsProperty metricsProperty) {
    ...
    public static class CustomWebMvcTagsContributor implements WebMvcTagsContributor {
        private final WebServiceMetricsProperty metricsProperty;
