package com.sensiblemetrics.api.customiere.metrics.property;

import com.sensiblemetrics.api.customiere.validation.constraint.NullOrNotBlank;
...
@ConfigurationProperties(prefix = WebServiceMetricsProperty.PROPERTY_PREFIX, ignoreInvalidFields = true)
@Role(BeanDefinition.ROLE_INFRASTRUCTURE)
@Description("SensibleMetrics WebService Metrics configuration properties")
public class WebServiceMetricsProperty {
    /**
     ...
     */
    private static final List<String> DEFAULT_SIMPLE_COMMON_TAGS = newArrayList("scope", "customiere");
    ...
    public static class Patterns {
         ...
         */
        public static final String PROPERTY_PREFIX = WebServiceMetricsProperty.PROPERTY_PREFIX + DEFAULT_PROPERTY_DELIMITER + "patterns";
    ...
    public static class Handlers {
         ...
         * Default handlers property prefix
         */
        public static final String PROPERTY_PREFIX = WebServiceMetricsProperty.PROPERTY_PREFIX + DEFAULT_PROPERTY_DELIMITER + "handlers";
