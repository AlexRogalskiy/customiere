...
@EnableR2dbcRepositories("com.sensiblemetrics.api.customiere.crm.clients.repository")
@Role(BeanDefinition.ROLE_INFRASTRUCTURE)
@Description("SensibleMetrics WebService DataSource configuration")
public class WebServiceDataSourceConfiguration {
    /**
     ...
     */
    private static final String[] DEFAULT_PACKAGES_TO_SCAN = {"com.sensiblemetrics.api.customiere.crm.clients.model.entity"};
