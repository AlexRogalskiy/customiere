...
import com.sensiblemetrics.api.customiere.commons.utils.ServiceUtils;
import lombok.Data;
...
@ConfigurationProperties(prefix = WebServiceApiStatusProperty.PROPERTY_PREFIX, ignoreInvalidFields = true)
@Role(BeanDefinition.ROLE_INFRASTRUCTURE)
@Description("SensibleMetrics Web Service Api Status configuration properties")
public class WebServiceApiStatusProperty {
    /**
