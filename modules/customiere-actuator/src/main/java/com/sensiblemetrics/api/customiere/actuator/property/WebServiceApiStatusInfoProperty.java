package com.sensiblemetrics.api.customiere.actuator.property;

import com.sensiblemetrics.api.customiere.validation.constraint.NullOrNotEmpty;
import com.sensiblemetrics.api.customiere.commons.helper.MapBuilder;
import lombok.Data;
...
@ConfigurationProperties(prefix = WebServiceApiStatusInfoProperty.PROPERTY_PREFIX, ignoreInvalidFields = true)
@Role(BeanDefinition.ROLE_INFRASTRUCTURE)
@Description("SensibleMetrics Web Service Info Api Status configuration properties")
public class WebServiceApiStatusInfoProperty {
    /**
     * Default info api status property prefix
     */
    public static final String PROPERTY_PREFIX = WebServiceApiStatusProperty.PROPERTY_PREFIX + DEFAULT_PROPERTY_DELIMITER + "node.info";
    ...
    private WebServiceApiStatusInfoProperty.InfoSettings settings = new InfoSettings();
    ...
    private WebServiceApiStatusInfoProperty.InfoParameterNames parameterNames = new InfoParameterNames();
    ...
    private WebServiceApiStatusInfoProperty.InfoMetrics metrics = new InfoMetrics();
