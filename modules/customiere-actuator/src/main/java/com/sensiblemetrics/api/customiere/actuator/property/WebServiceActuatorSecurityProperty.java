...
import static com.sensiblemetrics.api.customiere.commons.utils.ServiceUtils.streamOf;

@Data
@Validated
@Accessors(chain = true)
@ConfigurationProperties(prefix = WebServiceActuatorSecurityProperty.PROPERTY_PREFIX, ignoreInvalidFields = true)
@Role(BeanDefinition.ROLE_INFRASTRUCTURE)
@Description("SensibleMetrics Web Service Actuator Security configuration properties")
public class WebServiceActuatorSecurityProperty {
    /**
