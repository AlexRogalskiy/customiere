package com.sensiblemetrics.api.customiere.logger.property;
...
@ConfigurationProperties(prefix = WebServiceLoggingProperty.PROPERTY_PREFIX, ignoreInvalidFields = true)
@Role(BeanDefinition.ROLE_INFRASTRUCTURE)
@Description("SensibleMetrics WebService Logging configuration properties")
public class WebServiceLoggingProperty {
    /**
    ...
    public static class Handlers {
         ...
         */
        public static final String PROPERTY_PREFIX = WebServiceLoggingProperty.PROPERTY_PREFIX + DEFAULT_PROPERTY_DELIMITER + "handlers";
