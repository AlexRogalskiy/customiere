package com.sensiblemetrics.api.customiere.logger.aspect;

import com.sensiblemetrics.api.customiere.logger.annotation.LoggingInfo;
...
@Slf4j
@Aspect
@ConditionalOnProperty(prefix = WebServiceLoggingProperty.Handlers.REPORTING_PROPERTY_PREFIX, value = "enabled", havingValue = "true", matchIfMissing = true)
...
public class ReportingDataAspect {
     ...
     */
    @Pointcut("@annotation(com.sensiblemetrics.api.customiere.logger.annotation.LoggingInfo)" +
            "|| @within(com.sensiblemetrics.api.customiere.logger.annotation.LoggingInfo)")
