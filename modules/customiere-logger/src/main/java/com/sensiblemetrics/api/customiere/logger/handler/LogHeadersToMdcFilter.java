package com.sensiblemetrics.api.customiere.logger.handler;
...
import static com.sensiblemetrics.api.customiere.commons.utils.ServiceUtils.enumerationAsStream;
...
public class LogHeadersToMdcFilter extends OncePerRequestFilter {
    ...
    /**
     * Default {@link LogHeadersToMdcFilter} constructor by input {@link WebServiceLoggingProperty.HeadersHandler}
     *
     * @param headersHandler - initial input {@link WebServiceLoggingProperty.HeadersHandler}
     */
    public LogHeadersToMdcFilter(final WebServiceLoggingProperty.HeadersHandler headersHandler) {
